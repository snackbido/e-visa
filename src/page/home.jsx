          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="order-1 lg:order-2 flex justify-center items-center">
                ...
                <div className="bg-[url(https://www.kwalterconsulting.com/img/insurance/travel/19998723-travel-and-vacation-accessories-top-view-xxl.png)] bg-center from-indigo-100 to-purple-100 rounded-3xl w-full max-w-md lg:max-w-lg h-64 sm:h-80 lg:h-96 flex items-center justify-center p-6 sm:p-8">
